...
# drawn along with the Minkowski difference. If the shapes don't
...
# return the convex hull of hte Minkowski difference.
...
# a separating axis. Returns true if there is an intersection:
